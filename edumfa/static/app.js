 ...
 *
 */
myApp = angular.module("eduMfaApp",
    ['ui.router', 'ui.bootstrap', 'TokenModule',
        'ngIdle', 'ngSanitize',
        'eduMfaAuth',
        'eduMfaApp.auditStates',
        'eduMfaApp.configStates',
        'eduMfaApp.tokenStates',
        'eduMfaApp.dashboardStates',
        'eduMfaApp.userStates',
        'eduMfaApp.machineStates',
        'eduMfaApp.registerStates',
        'eduMfaApp.recoveryStates',
        'eduMfaApp.loginStates',
        'eduMfaApp.componentStates',
        'eduMfaApp.versioning',
            ...
            responseError: function (rejection) {
                ...
                if(rejection.status === 0) {
                    if (rejection.config.timeout) {
                        ...
                        inform.add(gettext("The eduMFA system seems to be" +
